...
#endif
#define LED_RMT_TX_CHANNEL		WS2812_RMT_CHANNEL
#define LED_RMT_TX_GPIO			  WS2812_LED_PIN
// ****************************************************


#if WS2812_LED_TYPE_RGBW
...
#ifndef WS2812_T0H
#define WS2812_T0H 14 // 0 bit high time
#define WS2812_T1H 52 // 1 bit high time
#define WS2812_T0L 52 // low time for either bit
#define WS2812_T1L 52
#endif

// These values are determined by measuring pulse timing with logic analyzer and adjusting to match datasheet. 
#define T0H	WS2812_T0H  // 0 bit high time
#define T1H	WS2812_T1H  // 1 bit high time
#define T0L	WS2812_T0L  // low time for either bit
#define T1L	WS2812_T1L
...
esp_err_t ws2812_control_init(void)
{
  ...
  ESP_RETURN_ON_ERROR(rmt_set_source_clk(config.channel, RMT_BASECLK_APB), TAG, "Failed to change clock source to APB.");
